...
const theCannon = {
  ...
  title: 'The Cannon',
  description:
    'Participate in a first turret kill before ten minutes into the game. (ARAM: before five minutes, Twisted Treeline: before eight minutes).',
  svgPath:
  ...
  obtainedCheck: ({ match, trophiesCategory }) => {
    ...
    if (trophiesCategory === TWISTED_TREELINE) {
      return match.participant.stats.earlyFirstTurretTT;
    }
