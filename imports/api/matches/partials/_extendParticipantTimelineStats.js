...
export function extendParticipantTimelineStats(extendedMatchResult, participant) {
  ...
  participant.stats.duoTriplekill = participantDuoKillParticipationsByTeammate.some(duoKills =>
  ...
  participant.stats.maxDuoKills = Math.max(
    ...participantDuoKillParticipationsByTeammate.map(event => event.length)
  );
