...
const dominus = {
  ...
  title: 'Dominus',
  description:
    'Achieve a 10 cs advantage over your opponent, 3 kills (at least one of them a solo kill) at 10 minutes into the game.',
  svgPath:
  ...
  obtainedCheck: ({ match }) => match.participant.stats.dominus,
  context: 'matches',
  attribute: 'power'
};
