...
const superiorPosition = {
  name: 'superiorPosition',
  title: 'Superior Position',
  description:
    'Have more than 1.34 times more damage dealt to champions than damage taken (from 1.67 times: SuperiorEquipment).',
  svgPath:
  ...
  score: SCORES.EASY,
  obtainedCheck: ({ match }) =>
    match.participant.stats.damageDealtToTakenRatio >= 1.34 &&
