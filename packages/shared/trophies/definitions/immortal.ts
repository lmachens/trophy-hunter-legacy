...
const immortal = {
  name: 'immortal',
  title: 'Immortal',
  description: "Win a game that lasts 25 minutes or more, but do not die. (Seriously, Don't die!)",
  svgPath:
  ...
  obtainedCheck: ({ match }) =>
    match.participant.stats.deaths < 1 && match.gameDuration >= 1500 && match.participant.stats.win,
  context: 'matches',
